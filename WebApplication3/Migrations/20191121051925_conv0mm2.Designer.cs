...
namespace WebApplication3.Migrations
{
    ...
    [Migration("20191121051925_conv0mm2")]
    partial class conv0mm2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication3.Models.conv4_ManyStudent", b =>
                {
                    b.Property<int>("DudeIdee")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("ClassIdee");

                    b.ToTable("conv4_ManyStudent");
                });

            modelBuilder.Entity("WebApplication3.Models.conv4_OneClass", b =>
                {
                    b.Property<int>("ClassIdee")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("WebApplication3.Models.conv0mm_ManyClass", b =>
                {
                    b.HasOne("WebApplication3.Models.conv0mm_ManyStudent", "Mobser")
                        .WithMany()
                        .HasForeignKey("MobserDudeIdee");

                    b.HasOne("WebApplication3.Models.conv0mm_ManyStudent", "TopDog")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplication3.Models.conv4_ManyStudent", b =>
                {
                    b.HasOne("WebApplication3.Models.conv4_OneClass", "ClassOfTheStudent")
                        .WithMany("AllStudentsInThisClass")
                        .HasForeignKey("ClassIdee")
                        .OnDelete(DeleteBehavior.Cascade);
                });
